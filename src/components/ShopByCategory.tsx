          ...
          {categories.map((cat) => (
            <StaggerItem key={cat.name}>
              <Link to={cat.href} className="group relative overflow-hidden aspect-square block">
                <img src={cat.image} alt={cat.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy" width={800} height={800} />
